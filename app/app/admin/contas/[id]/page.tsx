...
export default function AdminContaPage() {
  ...
  return <main className="ac"><style>{`
    .ac{min-height:100vh;background:linear-gradient(180deg,#F0EDF7,#ECE8F4);color:#21253A;padding:42px 5vw 80px;font-family:Sora,sans-serif}.wrap{max-width:1180px;margin:auto}.top{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.back{border:1px solid #262841;background:#ECE8F4;color:#4E556D;border-radius:10px;padding:9px 12px;cursor:pointer}.ey{font-size:11px;letter-spacing:2px;color:#6f76a0;text-transform:uppercase}.ac h1{font-size:30px;margin:7px 0 4px}.sub{color:#7a7f9a;font-size:13px}.grid{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-top:24px}.card{background:linear-gradient(180deg,#FAF8FD,#F3EFF9);border:1px solid #DCD6EE;border-radius:16px;padding:18px}.val{font-size:23px;font-weight:800}.lab{font-size:11px;color:#73758D;margin-top:6px}.sections{display:grid;grid-template-columns:1.15fr .85fr;gap:14px;margin-top:14px}.title{font-size:14px;font-weight:700;margin-bottom:13px}.rows{display:grid;gap:10px}.row{display:flex;justify-content:space-between;gap:18px;padding-bottom:9px;border-bottom:1px solid #E3DEEB;font-size:12px}.row span:first-child{color:#73758D}.status{display:inline-flex;padding:4px 8px;border-radius:999px;border:1px solid #2b2e4a;background:#F3EFF9;font-size:10px}.alert{margin-top:14px;border-radius:14px;padding:14px 16px}.alert strong{display:block}.alert p{color:#b6bbcf;font-size:11px;line-height:1.6;margin:7px 0 0}.susp{border:1px solid rgba(255,157,157,.28);background:rgba(255,157,157,.06)}.susp strong{color:#B95C66}.take{border:1px solid rgba(246,196,69,.28);background:rgba(246,196,69,.06)}.take strong{color:#9A6D10}.closing{border:1px solid rgba(255,157,157,.4);background:rgba(110,24,40,.13)}.closing strong{color:#945D64}.tablecard{margin-top:14px}.tablewrap{overflow:auto}.table{width:100%;border-collapse:collapse;min-width:760px}.table th,.table td{text-align:left;padding:11px 9px;border-bottom:1px solid #E3DEEB;font-size:11px}.table th{color:#777e9d;font-weight:600}.table td{color:#4E556D}.audit{display:grid;gap:9px}.auditItem{border:1px solid #E3DEEB;border-radius:11px;padding:11px 12px}.auditTop{display:flex;justify-content:space-between;gap:12px;font-size:11px}.auditMeta{font-size:10px;color:#73758D;margin-top:5px}.empty{color:#73758D;font-size:12px;padding:12px 0}.err{margin-top:22px;color:#B95C66}.warn{color:#9A6D10}.ok{color:#3F7C5B}@media(max-width:900px){.grid{grid-template-columns:1fr 1fr}.sections{grid-template-columns:1fr}}@media(max-width:560px){.ac{padding:28px 16px 60px}.grid{grid-template-columns:1fr}.top{flex-direction:column-reverse}}
