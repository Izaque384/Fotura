...
export default function AdminClosure({ userId, encerramento }: { userId: string; encerramento: Encerramento }) {
  ...
  return <>
    <section className="cl-card">
      <style>{`.cl-card,.pg-card{margin-top:14px;background:linear-gradient(180deg,#FAF8FD,#F3EFF9);border:1px solid rgba(255,157,157,.2);border-radius:16px;padding:18px}.cl-title,.pg-title{font-size:14px;font-weight:800;color:#21253A}.cl-sub,.pg-sub{font-size:11px;color:#8f95ad;line-height:1.6;margin:6px 0 14px}.cl-state,.pg-state{padding:11px 12px;border:1px solid #30253a;border-radius:11px;background:#F3EFF9;font-size:11px;color:#4E556D;margin-bottom:13px}.cl-state strong,.pg-state strong{color:#B95C66}.cl-grid,.pg-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.cl-field,.pg-field{display:grid;gap:6px}.cl-field label,.pg-field label{font-size:10px;color:#8f95ad}.cl-field textarea,.cl-field input,.pg-field textarea,.pg-field input{width:100%;box-sizing:border-box;background:#ECE8F4;border:1px solid #34243d;border-radius:10px;color:#21253A;padding:10px;font:12px inherit}.cl-field textarea,.pg-field textarea{min-height:78px;resize:vertical}.cl-actions,.pg-actions{display:flex;gap:9px;flex-wrap:wrap;margin-top:12px}.cl-btn,.pg-btn{border:1px solid #4c3042;background:#F8EDEE;color:#B95C66;border-radius:9px;padding:9px 12px;font:11px inherit;cursor:pointer}.cl-btn.cancel,.pg-btn.cancel{border-color:#39415e;background:#EEEAF8;color:#d6dbf1}.cl-btn.confirm,.pg-btn.arm{background:#4a171f;border-color:#76303a;color:#fff}.pg-btn.execute{background:#7c1725;border-color:#b03b4e;color:#fff;font-weight:700}.cl-btn:disabled,.pg-btn:disabled{opacity:.45;cursor:not-allowed}.cl-note,.pg-note{font-size:10px;color:#8f95ad;margin-top:10px;line-height:1.55}.cl-ok,.pg-ok{font-size:11px;color:#3F7C5B;margin-top:10px}.cl-err,.pg-err{font-size:11px;color:#B95C66;margin-top:10px}.pg-card{border-color:rgba(255,105,120,.32);background:linear-gradient(180deg,#F8EDEE,#F3EFF9)}.pg-title{color:#945D64}.pg-preview{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin:12px 0}.pg-metric{border:1px solid #322233;background:#F3EFF9;border-radius:10px;padding:10px}.pg-metric b{display:block;font-size:16px}.pg-metric span{font-size:9px;color:#8f95ad}.pg-safe{padding:10px 12px;border:1px solid rgba(143,227,176,.2);background:rgba(143,227,176,.05);border-radius:10px;color:#9ceabb;font-size:10px;margin-top:10px}.pg-danger{padding:10px 12px;border:1px solid rgba(255,105,120,.35);background:rgba(255,105,120,.07);border-radius:10px;color:#945D64;font-size:10px;margin-top:10px}@media(max-width:720px){.cl-grid,.pg-grid{grid-template-columns:1fr}.pg-preview{grid-template-columns:1fr 1fr}}`}</style>
