...
export default function AdminSaudePage() {
  ...
  return <main className="hs"><style>{`
    .hs{min-height:100vh;background:linear-gradient(180deg,#F0EDF7,#ECE8F4);color:#21253A;padding:46px 6vw 80px;font-family:Sora,sans-serif}.wrap{max-width:1080px;margin:auto}.top{display:flex;justify-content:space-between;gap:16px;align-items:flex-start}.ey{font-size:11px;letter-spacing:2px;color:#6f76a0;text-transform:uppercase}.hs h1{font-size:30px;margin:7px 0}.sub{font-size:12px;color:#7a7f9a}.actions{display:flex;gap:8px}.btn{border:1px solid #CFC6E6;background:#F3EFF9;color:#4E556D;border-radius:10px;padding:9px 12px;font:11px inherit;cursor:pointer}.hero{margin-top:24px;border:1px solid #DCD6EE;background:linear-gradient(180deg,#FAF8FD,#F3EFF9);border-radius:16px;padding:20px}.state{font-size:24px;font-weight:800}.ok{color:#3F7C5B}.warn{color:#9A6D10}.error{color:#B95C66}.metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-top:14px}.metric{border:1px solid #DCD6EE;border-radius:12px;padding:14px;background:#FAF8FD}.metric b{display:block;font-size:22px}.metric span{font-size:10px;color:#73758D}.checks{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:14px}.check{border:1px solid #DCD6EE;background:#FAF8FD;border-radius:14px;padding:16px}.ch{display:flex;align-items:center;justify-content:space-between;gap:12px}.name{font-size:13px;font-weight:700}.pill{padding:4px 8px;border-radius:999px;border:1px solid #CFC6E6;font-size:9px;text-transform:uppercase;letter-spacing:.6px}.pill.ok{border-color:rgba(143,227,176,.25);background:rgba(143,227,176,.06)}.pill.warn{border-color:rgba(246,196,69,.25);background:rgba(246,196,69,.06)}.pill.error{border-color:rgba(255,157,157,.3);background:rgba(255,157,157,.06)}.detail{margin-top:9px;color:#9197af;font-size:11px;line-height:1.55}.err{margin-top:20px;color:#B95C66}.loading{margin-top:24px;color:#7a7f9a}@media(max-width:760px){.checks{grid-template-columns:1fr}.metrics{grid-template-columns:1fr 1fr}.top{flex-direction:column}.actions{width:100%}.btn{flex:1}}`}</style><div className="wrap">
