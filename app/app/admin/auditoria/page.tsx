...
export default function AdminAuditoriaPage() {
  ...
  return <main className="aa"><style>{`
    .aa{min-height:100vh;background:linear-gradient(180deg,#F0EDF7,#ECE8F4);color:#21253A;padding:42px 5vw 80px;font-family:Sora,sans-serif}.wrap{max-width:1180px;margin:auto}.top{display:flex;justify-content:space-between;gap:18px;align-items:flex-start}.ey{font-size:11px;letter-spacing:2px;color:#6f76a0;text-transform:uppercase}.aa h1{font-size:30px;margin:7px 0 4px}.sub{color:#7a7f9a;font-size:13px}.back{border:1px solid #262841;background:#ECE8F4;color:#4E556D;border-radius:10px;padding:9px 12px;cursor:pointer}.toolbar{display:flex;justify-content:flex-end;margin:22px 0 12px}.search{width:min(420px,100%);background:#F3EFF9;border:1px solid #D7D0E7;border-radius:10px;color:#21253A;padding:10px 12px;font:12px inherit}.card{background:linear-gradient(180deg,#FAF8FD,#F3EFF9);border:1px solid #DCD6EE;border-radius:16px;padding:14px}.tablewrap{overflow:auto}.table{width:100%;border-collapse:collapse;min-width:950px}.table th,.table td{text-align:left;padding:11px 10px;border-bottom:1px solid #E3DEEB;font-size:11px;vertical-align:top}.table th{color:#777e9d;font-weight:600}.table td{color:#4E556D}.muted{color:#73758D;font-size:10px;margin-top:3px}.action{font-weight:700;color:#21253A}.pill{display:inline-flex;padding:4px 7px;border-radius:999px;background:#EEEAF8;border:1px solid #D7D0E7;font-size:10px}.err{margin-top:22px;color:#B95C66}.empty{color:#73758D;padding:20px;font-size:12px}@media(max-width:600px){.aa{padding:28px 16px 60px}.top{flex-direction:column-reverse}.toolbar{justify-content:stretch}.search{width:100%;box-sizing:border-box}}
