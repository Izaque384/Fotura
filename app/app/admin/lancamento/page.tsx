...
export default function AdminLancamentoPage() {
  ...
  return <main className="lr"><style>{`
    .lr{min-height:100vh;background:linear-gradient(180deg,#F0EDF7,#ECE8F4);color:#21253A;padding:46px 6vw 90px;font-family:Sora,sans-serif}.wrap{max-width:1050px;margin:auto}.top{display:flex;justify-content:space-between;gap:16px}.ey{font-size:11px;letter-spacing:2px;color:#6f76a0;text-transform:uppercase}.lr h1{font-size:30px;margin:7px 0}.sub{font-size:12px;color:#7a7f9a;line-height:1.6}.btn{border:1px solid #CFC6E6;background:#F3EFF9;color:#4E556D;border-radius:10px;padding:9px 12px;font:11px inherit;cursor:pointer}.summary{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:24px}.card{background:linear-gradient(180deg,#FAF8FD,#F3EFF9);border:1px solid #DCD6EE;border-radius:15px;padding:17px}.card b{font-size:25px;display:block}.card span{font-size:10px;color:#73758D}.ok{color:#3F7C5B}.manual{color:#9A6D10}.bloqueio{color:#B95C66}.items{display:grid;gap:10px;margin-top:14px}.item{background:#FAF8FD;border:1px solid #DCD6EE;border-radius:13px;padding:15px}.itemHead{display:flex;justify-content:space-between;gap:12px;align-items:center}.itemTitle{font-size:13px;font-weight:700}.pill{font-size:9px;padding:4px 8px;border-radius:999px;border:1px solid #CFC6E6;text-transform:uppercase}.pill.ok{border-color:rgba(143,227,176,.25);background:rgba(143,227,176,.06)}.pill.manual{border-color:rgba(246,196,69,.25);background:rgba(246,196,69,.06)}.pill.bloqueio{border-color:rgba(255,157,157,.3);background:rgba(255,157,157,.06)}.detail{font-size:11px;color:#9298af;line-height:1.55;margin-top:8px}.note{margin-top:16px;border:1px solid rgba(246,196,69,.22);background:rgba(246,196,69,.04);border-radius:13px;padding:14px;color:#c8c29d;font-size:11px;line-height:1.6}.err{color:#B95C66;margin-top:18px}@media(max-width:650px){.top{flex-direction:column}.summary{grid-template-columns:1fr}.itemHead{align-items:flex-start}}
