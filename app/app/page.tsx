    ...
    <div className="lp">
      ...
      <main>
        <section className="shell hero" id="produto">
          ...
          <div className="preview-wrap" aria-label="Prévia do painel Fotura">
            <div className="preview"><div className="preview-in"><div className="window"><i/><i/><i/></div><div className="app"><aside className="app-side"><div className="app-logo">FOTURA</div><div className="app-item on">Painel</div><div className="app-item">Galerias</div><div className="app-item">Seleções</div><div className="app-item">Clientes</div><div className="app-item">Configurações</div></aside><div className="app-main"><div className="app-head"><div><div className="app-title">Visão geral</div><div className="app-sub">Seu trabalho organizado em um só lugar.</div></div><span className="new">Nova galeria</span></div><div className="stats"><div className="stat"><b>12</b><span>Galerias ativas</span></div><div className="stat"><b>48</b><span>Clientes</span></div><div className="stat"><b>7</b><span>Seleções finalizadas</span></div></div><div className="app-grid"><div className="mini"><div className="mini-title">Galeria recente</div><div className="photos"><div className="photo"/><div className="photo"/><div className="photo"/></div></div><div className="mini"><div className="mini-title">Seleções</div><div className="rows"><div className="row"><span>Ensaio Mariana</span><span className="ok">Finalizada</span></div><div className="row"><span>Casamento L + R</span><span>Em andamento</span></div><div className="row"><span>Corporativo</span><span>12 fotos</span></div></div></div></div></div></div></div></div>
          </div>
        </section>
