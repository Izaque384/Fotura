...
export default function ConfiguracoesPage() {
  ...
  async function alternarNotificacoes() {
    ...
    if(pushAtivo){
      const ok=await desinscreverPush(uid);
      setAlterandoPush(false);
      if(ok){setPushAtivo(false);setMensagem("Notificações desativadas neste navegador.");}
      else{setErro(true);setMensagem("Não foi possível desativar as notificações neste navegador.");}
      return;
    }
