...
const gratuito = PLANOS_FOTURA.gratis;
...
export default function AssinaturaPage() {
  ...
  return <main className="bill-page mf-shift">
    <MenuFotografo/>
    <style>{`
      .bill-page{min-height:100vh;box-sizing:border-box;background:linear-gradient(180deg,#F0EDF7 0%,#ECE8F4 100%);color:#21253A;padding-top:46px;padding-right:5vw;padding-bottom:80px}.bill-wrap{width:100%;max-width:1220px;margin:0 auto;box-sizing:border-box;padding-left:clamp(28px,4vw,64px)}.bill-top{display:flex;align-items:end;justify-content:space-between;gap:20px;margin-bottom:22px}.bill-ey{font-size:11px;letter-spacing:2px;color:#6f76a0;text-transform:uppercase}.bill-h1{font-size:30px;letter-spacing:-.7px;margin:7px 0 5px}.bill-sub{margin:0;color:#7a7f9a;font-size:13px;line-height:1.6;max-width:650px}.bill-notice{margin:0 0 18px;padding:12px 14px;border-radius:11px;border:1px solid rgba(126,162,255,.24);background:rgba(74,108,247,.08);color:#cbd4ff;font-size:12px}.bill-notice.err{border-color:rgba(255,157,157,.2);background:rgba(255,157,157,.06);color:#B95C66}.current{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(340px,.92fr);gap:18px;margin-bottom:28px}.card{background:linear-gradient(180deg,#FAF8FD,#F3EFF9);border:1px solid #DCD6EE;border-radius:16px;min-width:0}.current-main{padding:22px}.current-head{display:flex;align-items:center;justify-content:space-between;gap:16px}.current-name{font-size:24px;font-weight:750}.tag{border-radius:999px;padding:6px 9px;font-size:10px;font-weight:700;background:rgba(143,227,176,.08);border:1px solid rgba(143,227,176,.2);color:#3F7C5B}.legacy{margin-top:13px;padding:11px 12px;border-radius:10px;background:rgba(246,196,69,.06);border:1px solid rgba(246,196,69,.17);color:#c9b46f;font-size:11px;line-height:1.55}.manage-btn{margin-top:15px;border:1px solid #323650;border-radius:10px;background:#EEEAF8;color:#dfe2f3;padding:9px 12px;font:650 11px inherit;cursor:pointer}.manage-btn:disabled{opacity:.5;cursor:default}.usage{padding:22px}.usage-title{font-size:12px;font-weight:700;margin-bottom:16px}.meter{margin:0 0 14px}.meter:last-child{margin-bottom:0}.meter-head{display:flex;justify-content:space-between;gap:12px;font-size:11px;color:#969cb6;margin-bottom:7px}.track{height:7px;border-radius:999px;background:#F0EDF7;overflow:hidden}.fill{height:100%;border-radius:inherit;background:linear-gradient(90deg,#1196fc,#5d0dfa)}.free-plan{display:flex;align-items:center;justify-content:space-between;gap:20px;margin:0 0 18px;padding:16px 18px;border:1px solid #2b2e49;border-radius:14px;background:linear-gradient(135deg,rgba(17,150,252,.08),rgba(93,13,250,.07))}.free-plan b{display:block;font-size:13px;margin-bottom:5px}.free-plan p{margin:0;color:#858ba4;font-size:10.5px;line-height:1.55}.free-badge{flex:none;border:1px solid rgba(143,227,176,.25);background:rgba(143,227,176,.07);color:#3F7C5B;border-radius:999px;padding:7px 10px;font-size:9px;font-weight:800}.plans-head{display:flex;align-items:end;justify-content:space-between;gap:20px;margin:0 0 14px}.plans-head h2{font-size:21px;margin:0}.plans-head p{font-size:11px;color:#717892;margin:0}.plans{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.plan{position:relative;padding:22px;display:flex;flex-direction:column;min-height:410px}.plan.featured{border-color:rgba(74,108,247,.62);box-shadow:0 14px 45px rgba(25,35,100,.18),inset 0 1px 0 rgba(255,255,255,.025)}.recommended{position:absolute;right:16px;top:15px;border-radius:999px;background:linear-gradient(90deg,#1196fc,#5d0dfa);font-size:9px;font-weight:750;padding:6px 9px}.plan-name{font-size:19px;font-weight:750}.plan-desc{font-size:11px;line-height:1.55;color:#777e98;margin:8px 0 18px;min-height:52px}.price{font-size:31px;font-weight:800;letter-spacing:-1px}.month{font-size:11px;color:#73758D;margin-left:4px}.features{display:grid;gap:9px;margin:19px 0 22px;padding:0;list-style:none}.features li{font-size:11px;color:#adb2c8;display:flex;gap:8px;line-height:1.4}.features li:before{content:'✓';color:#3F7C5B;font-weight:800}.plan-btn{margin-top:auto;width:100%;border:1px solid #323650;border-radius:11px;background:#F3EFF9;color:#dfe2f3;padding:12px 14px;font:650 12px inherit;cursor:pointer}.plan-btn.primary{border:0;background:linear-gradient(90deg,#1196fc,#5d0dfa);color:white}.plan-btn:disabled{opacity:.48;cursor:default}.fine{font-size:10px;color:#5f657f;text-align:center;margin-top:16px;line-height:1.5}.loading{min-height:45vh;display:grid;place-items:center;color:#747b97}@media(max-width:1100px){.plans{grid-template-columns:1fr 1fr}.plan:last-child{grid-column:1/-1}}@media(max-width:900px){.bill-wrap{padding-left:clamp(24px,4vw,42px)}.current{grid-template-columns:1fr}.plans{grid-template-columns:1fr}.plan:last-child{grid-column:auto}.plan{min-height:0}}@media(max-width:640px){.free-plan{align-items:flex-start;flex-direction:column}.bill-page{padding-top:82px;padding-right:18px;padding-bottom:60px}.bill-wrap{padding-left:18px}.bill-top,.plans-head{align-items:flex-start;flex-direction:column}.bill-h1{font-size:27px}.current-main,.usage,.plan{padding:18px}.meter-head{font-size:10.5px}}
    `}</style>
    <div className="bill-wrap">
      ...
      {carregando ? <div className="loading">Carregando assinatura…</div> : <>
        ...
        <div className="free-plan"><div><b>Plano Grátis · {limite(gratuito.limites.armazenamentoGb," GB")} para começar</b><p>Galerias, clientes e fotos por galeria ilimitados. Sem cartão de crédito. Se uma assinatura paga terminar, sua conta continua no plano Grátis.</p></div><span className="free-badge">{atual==="gratis"?"SEU PLANO":"INCLUÍDO"}</span></div><div className="plans-head"><div><div className="bill-ey">Planos pagos</div><h2>Escolha quanto armazenamento sua operação precisa</h2></div><p>Sem limite de galerias, clientes ou fotos por galeria.</p></div>
