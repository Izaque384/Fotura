...
export default function HerosGaleriaPage() {
  ...
  if (carregando) return <div className="hero-loading">Carregando personalização…<style>{`.hero-loading{min-height:100vh;display:grid;place-items:center;background:linear-gradient(180deg,#F0EDF7,#ECE8F4);color:#7a7f9a}`}</style></div>;

  return <main className="hero-page mf-shift"><MenuFotografo/><style>{`
    .hero-page{min-height:100vh;background:linear-gradient(180deg,#F0EDF7,#ECE8F4);color:#21253A}.body{max-width:1040px;margin:auto;padding:46px 40px 80px}.top{display:flex;align-items:flex-end;justify-content:space-between;gap:18px}.ey{font-size:11px;letter-spacing:2px;color:#6f76a0}.h1{font-size:30px;margin:7px 0}.sub{font-size:13px;color:#7a7f9a;line-height:1.55}.back,.btn{border:1px solid #D7D0E7;border-radius:10px;background:#FAF8FD;color:#cfd5ea;padding:10px 13px;font:600 12px inherit;cursor:pointer}.btn.primary{border:0;color:#21253A;background:linear-gradient(90deg,#1196fc,#5d0dfa)}.upgrade{margin-top:22px;padding:15px 17px;border:1px solid rgba(93,13,250,.32);border-radius:14px;background:linear-gradient(135deg,rgba(17,150,252,.07),rgba(93,13,250,.07));display:flex;justify-content:space-between;align-items:center;gap:16px}.upgrade strong{font-size:13px}.upgrade p{font-size:11px;color:#858ba8;margin:4px 0 0}.notice{margin-top:16px;padding:11px 13px;border-radius:10px;font-size:12px;color:#3F7C5B;background:rgba(143,227,176,.06);border:1px solid rgba(143,227,176,.18)}.notice.err{color:#B95C66;background:rgba(255,157,157,.06);border-color:rgba(255,157,157,.18)}.list{display:grid;gap:10px;margin-top:22px}.row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:center;padding:16px 17px;border:1px solid #23263e;border-radius:14px;background:linear-gradient(180deg,#FAF8FD,#F3EFF9)}.name{font-size:14px;font-weight:650}.meta{font-size:11px;color:#747a96;margin-top:5px}.badge{display:inline-flex;margin-left:8px;padding:3px 7px;border-radius:999px;font-size:9px;font-weight:750;border:1px solid rgba(143,227,176,.28);color:#9fe8bc;background:rgba(143,227,176,.06)}.badge.off{color:#8c91a8;border-color:#2b2e47;background:#FAF8FD}.actions{display:flex;gap:8px;align-items:center}.empty{margin-top:22px;padding:40px;text-align:center;color:#747a96;border:1px solid #23263e;border-radius:14px;background:#FAF8FD}.modal{position:fixed;inset:0;z-index:130;background:rgba(3,3,12,.82);display:flex;align-items:center;justify-content:center;padding:18px}.panel{width:min(900px,100%);max-height:90vh;overflow:auto;padding:22px;border:1px solid #292c47;border-radius:17px;background:linear-gradient(180deg,#FAF8FD,#F3EFF9)}.mhead{display:flex;justify-content:space-between;gap:15px;align-items:flex-start}.close{width:38px;height:38px;border:1px solid #D7D0E7;border-radius:10px;background:#FAF8FD;color:#cfd5ea;font-size:19px}.hero-option{margin-top:18px;padding:14px;border:1px solid #292d47;border-radius:13px;background:#F3EFF9;display:flex;align-items:center;justify-content:space-between;gap:16px}.hero-option strong{font-size:13px}.hero-option p{font-size:11px;color:#747b97;margin:4px 0 0}.hero-option.locked{border-color:rgba(246,196,69,.24)}.photos{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:9px;margin-top:18px}.photo{position:relative;aspect-ratio:1;border:2px solid transparent;border-radius:11px;overflow:hidden;padding:0;background:#ECE8F4;cursor:pointer}.photo img{width:100%;height:100%;object-fit:cover}.photo.on{border-color:#5d6dfa}.photo.on:after{content:'CAPA';position:absolute;left:7px;bottom:7px;padding:3px 6px;border-radius:999px;background:rgba(8,9,20,.82);color:#21253A;font-size:8px;font-weight:800;letter-spacing:.5px}.loading{text-align:center;padding:40px;color:#737992}@media(max-width:760px){.body{padding:76px 14px 60px}.top{align-items:flex-start;flex-direction:column}.upgrade,.hero-option{align-items:flex-start;flex-direction:column}.row{grid-template-columns:1fr}.actions{justify-content:flex-start;flex-wrap:wrap}.photos{grid-template-columns:repeat(3,minmax(0,1fr))}.panel{padding:17px}.h1{font-size:25px}}`}</style>
